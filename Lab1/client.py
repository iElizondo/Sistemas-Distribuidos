...
if __name__ == "__main__":
	host = "127.0.0.1" #"192.168.0.105" #"10.251.45.41" #"192.168.0.110"    "10.251.45.95"
	puerto = 44440
	msg = ""
	while True:
		...
		operacion = int(input("Cual calculo desea realizar: 1- Suma, 2- Multiplicacion, 3-Resta, 4-Division: "))
